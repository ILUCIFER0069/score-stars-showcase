...
export const participants: Participant[] = [
  ...
  { id: 15, name: "Talenson", points: 4400, history: [] = [{id:31, date:"1-04-2025", points:1100, reason:"Day 1 Task Submission and Winner(1)."},
                                                          {id:30, date:"2-04-2025", points:1100, reason:"Day 2 Task Submission and Winner(1)."},
                                                          {id:29, date:"3-04-2025", points:1100, reason:"Day 1 Task Submission and Winner(1)."},
                                                          {id:28, date:"4-04-2025", points:1100, reason:"Day 1 Task Submission and Winner(1)."},
                                                          ];},
